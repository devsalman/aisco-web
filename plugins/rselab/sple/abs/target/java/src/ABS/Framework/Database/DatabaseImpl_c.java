...
public class DatabaseImpl_c extends abs.backend.java.lib.runtime.ABSObject implements abs.backend.java.lib.types.ABSClass, ABS.Framework.Database.Database_i {
    ...
    public  abs.backend.java.lib.types.ABSString fli_connect(abs.backend.java.lib.types.ABSString msg) {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("/home/salman/Workspaces/aisco-web/plugins/rselab/sple/abs/src/abs/framework/Database.abs",0);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("/home/salman/Workspaces/aisco-web/plugins/rselab/sple/abs/src/abs/framework/Database.abs",11);
