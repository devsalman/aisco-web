...
public interface ProgramController_i extends abs.backend.java.lib.types.ABSInterface {
    ...
    public  abs.backend.java.lib.runtime.ABSFut<ABS.StdLib.Pair<abs.backend.java.lib.types.ABSString,ABS.StdLib.List<MProgramModel.Program_i>>> async_create(ABS.Framework.Http.ABSHttpRequest_i request);
    // ProgramController.abs:11:1: 
    public  ABS.StdLib.Pair<abs.backend.java.lib.types.ABSString,ABS.StdLib.List<MProgramModel.Program_i>> create(ABS.Framework.Http.ABSHttpRequest_i request);
