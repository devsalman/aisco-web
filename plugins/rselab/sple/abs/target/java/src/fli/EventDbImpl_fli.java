// generated java fli code for EventImpl
package MEventDbImpl;
import MEventModel.*;
import com.fmse.abs.orm.AbsDbOrm;
import java.lang.reflect.Method;
public class EventDbImpl_fli extends EventDbImpl_c {
	@Override
	public ABS.StdLib.List<Event_i> fli_findAllByAttributes(abs.backend.java.lib.types.ABSString className, abs.backend.java.lib.types.ABSString condition) {
		...
		ABS.StdLib.List<Event_i> listObject = new ABS.StdLib.List_Nil();
		...
		do
		{
			...
			listObject = ABS.StdLib.appendright_f.apply(listObject, (Event_i) object);
	...
	@Override
	public ABS.StdLib.List<Event_i> fli_findAll(abs.backend.java.lib.types.ABSString className) {
		return this.fli_findAllByAttributes(className, abs.backend.java.lib.types.ABSString.fromString(""));
	}
	@Override
	public Event_i fli_findByAttributes(abs.backend.java.lib.types.ABSString className, abs.backend.java.lib.types.ABSString condition) {
		AbsDbOrm absdborm = new AbsDbOrm();
		return (Event_i) absdborm.findByAttributes(className, condition);
	}


	@Override
	public Event_i fli_find(abs.backend.java.lib.types.ABSString className) {
		return this.fli_findByAttributes(className, abs.backend.java.lib.types.ABSString.fromString(""));
	}


	@Override
	public abs.backend.java.lib.types.ABSUnit fli_save(Event_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
	...
	@Override
	public abs.backend.java.lib.types.ABSUnit fli_delete(Event_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
	...
	@Override
	public Event_i fli_update(Event_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
