// generated java fli code for IncomeImpl
package MIncomeDbImpl;
import MIncomeModel.*;
import com.fmse.abs.orm.AbsDbOrm;
import java.lang.reflect.Method;
public class IncomeDbImpl_fli extends IncomeDbImpl_c {
	@Override
	public ABS.StdLib.List<Income_i> fli_findAllByAttributes(abs.backend.java.lib.types.ABSString className, abs.backend.java.lib.types.ABSString condition) {
		...
		ABS.StdLib.List<Income_i> listObject = new ABS.StdLib.List_Nil();
		...
		do
		{
			...
			listObject = ABS.StdLib.appendright_f.apply(listObject, (Income_i) object);
	...
	@Override
	public ABS.StdLib.List<Income_i> fli_findAll(abs.backend.java.lib.types.ABSString className) {
		return this.fli_findAllByAttributes(className, abs.backend.java.lib.types.ABSString.fromString(""));
	}
	@Override
	public Income_i fli_findByAttributes(abs.backend.java.lib.types.ABSString className, abs.backend.java.lib.types.ABSString condition) {
		AbsDbOrm absdborm = new AbsDbOrm();
		return (Income_i) absdborm.findByAttributes(className, condition);
	}


	@Override
	public Income_i fli_find(abs.backend.java.lib.types.ABSString className) {
		return this.fli_findByAttributes(className, abs.backend.java.lib.types.ABSString.fromString(""));
	}


	@Override
	public abs.backend.java.lib.types.ABSUnit fli_save(Income_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
	...
	@Override
	public abs.backend.java.lib.types.ABSUnit fli_delete(Income_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
	...
	@Override
	public Income_i fli_update(Income_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
