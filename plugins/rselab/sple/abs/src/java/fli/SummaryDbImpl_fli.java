// generated java fli code for SummaryImpl
package MSummaryDbImpl;
import MSummaryModel.*;
import com.fmse.abs.orm.AbsDbOrm;
import java.lang.reflect.Method;
public class SummaryDbImpl_fli extends SummaryDbImpl_c {
	@Override
	public ABS.StdLib.List<Summary_i> fli_findAllByAttributes(abs.backend.java.lib.types.ABSString className, abs.backend.java.lib.types.ABSString condition) {
		...
		ABS.StdLib.List<Summary_i> listObject = new ABS.StdLib.List_Nil();
		...
		do
		{
			...
			listObject = ABS.StdLib.appendright_f.apply(listObject, (Summary_i) object);
	...
	@Override
	public ABS.StdLib.List<Summary_i> fli_findAll(abs.backend.java.lib.types.ABSString className) {
		return this.fli_findAllByAttributes(className, abs.backend.java.lib.types.ABSString.fromString(""));
	}
	@Override
	public Summary_i fli_findByAttributes(abs.backend.java.lib.types.ABSString className, abs.backend.java.lib.types.ABSString condition) {
		AbsDbOrm absdborm = new AbsDbOrm();
		return (Summary_i) absdborm.findByAttributes(className, condition);
	}


	@Override
	public Summary_i fli_find(abs.backend.java.lib.types.ABSString className) {
		return this.fli_findByAttributes(className, abs.backend.java.lib.types.ABSString.fromString(""));
	}


	@Override
	public abs.backend.java.lib.types.ABSUnit fli_save(Summary_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
	...
	@Override
	public abs.backend.java.lib.types.ABSUnit fli_delete(Summary_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
	...
	@Override
	public Summary_i fli_update(Summary_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
