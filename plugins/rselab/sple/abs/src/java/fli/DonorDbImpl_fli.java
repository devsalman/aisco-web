// generated java fli code for DonorImpl
package MDonorDbImpl;
import MDonorModel.*;
import com.fmse.abs.orm.AbsDbOrm;
import java.lang.reflect.Method;
public class DonorDbImpl_fli extends DonorDbImpl_c {
	@Override
	public ABS.StdLib.List<Donor_i> fli_findAllByAttributes(abs.backend.java.lib.types.ABSString className, abs.backend.java.lib.types.ABSString condition) {
		...
		ABS.StdLib.List<Donor_i> listObject = new ABS.StdLib.List_Nil();
		...
		do
		{
			...
			listObject = ABS.StdLib.appendright_f.apply(listObject, (Donor_i) object);
	...
	@Override
	public ABS.StdLib.List<Donor_i> fli_findAll(abs.backend.java.lib.types.ABSString className) {
		return this.fli_findAllByAttributes(className, abs.backend.java.lib.types.ABSString.fromString(""));
	}
	@Override
	public Donor_i fli_findByAttributes(abs.backend.java.lib.types.ABSString className, abs.backend.java.lib.types.ABSString condition) {
		AbsDbOrm absdborm = new AbsDbOrm();
		return (Donor_i) absdborm.findByAttributes(className, condition);
	}


	@Override
	public Donor_i fli_find(abs.backend.java.lib.types.ABSString className) {
		return this.fli_findByAttributes(className, abs.backend.java.lib.types.ABSString.fromString(""));
	}


	@Override
	public abs.backend.java.lib.types.ABSUnit fli_save(Donor_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
	...
	@Override
	public abs.backend.java.lib.types.ABSUnit fli_delete(Donor_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
	...
	@Override
	public Donor_i fli_update(Donor_i object) {
		AbsDbOrm absdborm = new AbsDbOrm();
